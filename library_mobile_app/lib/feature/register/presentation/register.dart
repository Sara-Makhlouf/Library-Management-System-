...
import 'package:library_mobile_app/core/constant.dart'; // استيراد ملف الكلاس Routes
import 'package:library_mobile_app/feature/presentation/signin_screen.dart';
import 'package:library_mobile_app/feature/register/bloc/bloc.dart';
...
class Register extends StatelessWidget {
  ...
  // استخدام ValueNotifier بدلاً من setState لإخفاء وإظهار كلمات المرور
  final ValueNotifier<bool> _obscure1Notifier = ValueNotifier<bool>(true);
  final ValueNotifier<bool> _obscure2Notifier = ValueNotifier<bool>(true);
            ...
            listener: (context, state) {
              if (state is AuthSuccess) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      state.responseData['message'] ?? 'تم تسجيل الحساب بنجاح',
                    ),
                  ),
                );

                // 🔥 التعديل هنا: الانتقال إلى الصفحة الرئيسية باستخدام الـ Named Route المشروطة في AppRouter
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ValueListenableBuilder<bool>(
                                      valueListenable: _obscure1Notifier,
                                      builder: (context, obscure1, child) {
                                        return _Field(
