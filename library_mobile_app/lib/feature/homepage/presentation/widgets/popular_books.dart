// library_mobile_app/feature/homepage/presentation/widgets/popular_books_slider.dart
...
class _PopularBooksSliderState extends State<PopularBooksSlider> {
  ...
  Widget build(BuildContext context) {
    ...
    const String baseUrl = "http://192.168.1.18:8000/";
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              print(
                                                'تم التفاعل مع زر الإعجاب لكتاب: ${book.title}',
                                              );
                                            },
                                            child: Container(
