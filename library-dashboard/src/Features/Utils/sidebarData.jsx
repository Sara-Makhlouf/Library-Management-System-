...
export const GOLDDIM = "rgba(201,168,76,0.08)";
export const GOLDBORDER = "rgba(201,168,76,0.18)";
export const MUTED  = "rgba(255,255,255,0.38)";
export const BRIGHT = "rgba(255,255,255,0.82)";
export const HOVER  = "rgba(255,255,255,0.04)";